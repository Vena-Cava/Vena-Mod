...
public class MCreatorBaobabsapling extends Elementsvenamod.ModElement {
	@GameRegistry.ObjectHolder("venamod:baobabsapling")
	public static final Block block = null;

	public MCreatorBaobabsapling(Elementsvenamod instance) {
		super(instance, 18);
	}
	...
	public static class BlockCustom extends Block {
		...
		public void randomDisplayTick(IBlockState state, World world, BlockPos pos, Random random) {
			...
			Block block = this;
			{
				...
				MCreatorBaobabSaplingGrow.executeProcedure($_dependencies);
			}
		}
		...
		public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer entity, EnumHand hand, EnumFacing direction,
			...
			Block block = this;
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				MCreatorBaobabsaplingBonemeal.executeProcedure($_dependencies);
			}
			return true;
		}
	}
