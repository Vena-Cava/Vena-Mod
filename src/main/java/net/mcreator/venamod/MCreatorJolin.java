...
public class MCreatorJolin extends Elementsvenamod.ModElement {
	...
	public MCreatorJolin(Elementsvenamod instance) {
		super(instance, 54);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ModTrigger().setUnlocalizedName("jolin").setRegistryName("jolin"));
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("venamod:jolin", "inventory"));
	}
					...
					for (int l7 = 1; l7 < 3; ++l7) {
						for (int k8 = -1; k8 < 3; ++k8) {
							...
							this.world.setBlockState(new BlockPos(k9, k10, k11), flag
									? Blocks.SNOW.getDefaultState().getBlock().getDefaultState()
	...
	public static class ChunkProviderModded implements IChunkGenerator {
		private static final IBlockState STONE = MCreatorPermafrost.block.getDefaultState();
		private static final IBlockState STONE2 = Blocks.SNOW.getDefaultState();
		private static final IBlockState FLUID = MCreatorAntifreeze.block.getDefaultState();
