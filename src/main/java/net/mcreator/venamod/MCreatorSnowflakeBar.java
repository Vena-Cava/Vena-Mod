...
public class MCreatorSnowflakeBar extends Elementsvenamod.ModElement {
	public MCreatorSnowflakeBar(Elementsvenamod instance) {
		super(instance, 59);
	}
		...
		public void eventHandler(RenderGameOverlayEvent event) {
			if (!event.isCancelable() && event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
				...
				if ((((entity.dimension) == (MCreatorJolin.DIMID)) && (!((entity instanceof EntityPlayer)
						...
						: false)))) {
					Minecraft.getMinecraft().renderEngine.bindTexture(new ResourceLocation("venamod:textures/snowflake_bar - copy.png"));
