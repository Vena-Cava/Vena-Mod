...
public class MCreatorStrawberryBush extends Elementsvenamod.ModElement {
	@GameRegistry.ObjectHolder("venamod:strawberrybush")
	public static final Block block = null;

	public MCreatorStrawberryBush(Elementsvenamod instance) {
		super(instance, 46);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("venamod:strawberrybush", "inventory"));
	}
