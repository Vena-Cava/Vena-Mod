...
public class MCreatorMangrovewood extends Elementsvenamod.ModElement {
	@GameRegistry.ObjectHolder("venamod:mangrovewood")
	public static final Block block = null;

	public MCreatorMangrovewood(Elementsvenamod instance) {
		super(instance, 40);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("venamod:mangrovewood", "inventory"));
	}
