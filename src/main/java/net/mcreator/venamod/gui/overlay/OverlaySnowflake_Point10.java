...
public class OverlaySnowflake_Point10 extends ElementsVenaMod.ModElement {
	public OverlaySnowflake_Point10(ElementsVenaMod instance) {
		super(instance, 77);
	}
		...
		public void eventHandler(RenderGameOverlayEvent event) {
			if (!event.isCancelable() && event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
				...
				if (((((entity.dimension) == (WorldJolin.DIMID))
						...
						&& ((VenaModVariables.MapVariables.get(world).Heat) >= 10))) {
