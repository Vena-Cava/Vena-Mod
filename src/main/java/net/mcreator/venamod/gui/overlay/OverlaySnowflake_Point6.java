...
public class OverlaySnowflake_Point6 extends ElementsVenaMod.ModElement {
	public OverlaySnowflake_Point6(ElementsVenaMod instance) {
		super(instance, 73);
	}
		...
		public void eventHandler(RenderGameOverlayEvent event) {
			if (!event.isCancelable() && event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
				...
				if (((((entity.dimension) == (WorldJolin.DIMID))
						...
						&& ((VenaModVariables.MapVariables.get(world).Heat) >= 6))) {
