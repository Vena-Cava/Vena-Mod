...
public class OverlaySnowflake_Point1 extends ElementsVenaMod.ModElement {
	public OverlaySnowflake_Point1(ElementsVenaMod instance) {
		super(instance, 68);
	}
		...
		public void eventHandler(RenderGameOverlayEvent event) {
			if (!event.isCancelable() && event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
				...
				if (((((entity.dimension) == (WorldJolin.DIMID))
						...
						&& ((VenaModVariables.MapVariables.get(world).Heat) >= 1))) {
