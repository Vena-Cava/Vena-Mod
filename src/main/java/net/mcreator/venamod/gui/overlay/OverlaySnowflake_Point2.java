...
public class OverlaySnowflake_Point2 extends ElementsVenaMod.ModElement {
	public OverlaySnowflake_Point2(ElementsVenaMod instance) {
		super(instance, 69);
	}
		...
		public void eventHandler(RenderGameOverlayEvent event) {
			if (!event.isCancelable() && event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
				...
				if (((((entity.dimension) == (WorldJolin.DIMID))
						...
						&& ((VenaModVariables.MapVariables.get(world).Heat) >= 2))) {
