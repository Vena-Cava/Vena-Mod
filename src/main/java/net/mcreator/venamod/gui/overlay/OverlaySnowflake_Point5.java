...
public class OverlaySnowflake_Point5 extends ElementsVenaMod.ModElement {
	public OverlaySnowflake_Point5(ElementsVenaMod instance) {
		super(instance, 72);
	}
		...
		public void eventHandler(RenderGameOverlayEvent event) {
			if (!event.isCancelable() && event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
				...
				if (((((entity.dimension) == (WorldJolin.DIMID))
						...
						&& ((VenaModVariables.MapVariables.get(world).Heat) >= 5))) {
