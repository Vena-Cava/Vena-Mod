...
public class OverlaySnowflake_Point8 extends ElementsVenaMod.ModElement {
	public OverlaySnowflake_Point8(ElementsVenaMod instance) {
		super(instance, 75);
	}
		...
		public void eventHandler(RenderGameOverlayEvent event) {
			if (!event.isCancelable() && event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
				...
				if (((((entity.dimension) == (WorldJolin.DIMID))
						...
						&& ((VenaModVariables.MapVariables.get(world).Heat) >= 8))) {
