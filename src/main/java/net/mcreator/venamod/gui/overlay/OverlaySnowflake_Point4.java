...
public class OverlaySnowflake_Point4 extends ElementsVenaMod.ModElement {
	public OverlaySnowflake_Point4(ElementsVenaMod instance) {
		super(instance, 71);
	}
		...
		public void eventHandler(RenderGameOverlayEvent event) {
			if (!event.isCancelable() && event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
				...
				if (((((entity.dimension) == (WorldJolin.DIMID))
						...
						&& ((VenaModVariables.MapVariables.get(world).Heat) >= 4))) {
