...
public class OverlaySnowflake_Point7 extends ElementsVenaMod.ModElement {
	public OverlaySnowflake_Point7(ElementsVenaMod instance) {
		super(instance, 74);
	}
		...
		public void eventHandler(RenderGameOverlayEvent event) {
			if (!event.isCancelable() && event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
				...
				if (((((entity.dimension) == (WorldJolin.DIMID))
						...
						&& ((VenaModVariables.MapVariables.get(world).Heat) >= 7))) {
