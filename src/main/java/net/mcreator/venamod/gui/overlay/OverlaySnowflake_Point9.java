...
public class OverlaySnowflake_Point9 extends ElementsVenaMod.ModElement {
	public OverlaySnowflake_Point9(ElementsVenaMod instance) {
		super(instance, 76);
	}
		...
		public void eventHandler(RenderGameOverlayEvent event) {
			if (!event.isCancelable() && event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
				...
				if (((((entity.dimension) == (WorldJolin.DIMID))
						...
						&& ((VenaModVariables.MapVariables.get(world).Heat) >= 9))) {
