...
package net.mcreator.venamod.world;
...
import net.mcreator.venamod.procedure.ProcedureJolinPlayerLeavesDimension;
import net.mcreator.venamod.item.ItemJolin;
import net.mcreator.venamod.block.BlockPermafrost;
import net.mcreator.venamod.block.BlockAntifreeze;
...
public class WorldJolin extends ElementsVenaMod.ModElement {
	public static int DIMID = 3;
	public static final boolean NETHER_TYPE = false;
	@GameRegistry.ObjectHolder("venamod:jolin_portal")
	public static final BlockCustomPortal portal = null;
	public static DimensionType dtype;
	public WorldJolin(ElementsVenaMod instance) {
		super(instance, 37);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ItemJolin().setUnlocalizedName("jolin").setRegistryName("jolin"));
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		if (DimensionManager.isDimensionRegistered(DIMID)) {
			...
			System.err.println("Dimension ID for dimension jolin is already registered. Falling back to ID: " + DIMID);
		}
		dtype = DimensionType.register("jolin", "_jolin", DIMID, WorldProviderMod.class, true);
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(ItemJolin.block, 0, new ModelResourceLocation("venamod:jolin", "inventory"));
	}
	public static class WorldProviderMod extends WorldProvider {
		...
		public void onPlayerRemoved(EntityPlayerMP entity) {
			...
			int z = (int) entity.posZ;
			{
				...
				ProcedureJolinPlayerLeavesDimension.executeProcedure($_dependencies);
			}
		}
	}
	...
	public static class BlockCustomPortal extends BlockPortal {
		public BlockCustomPortal() {
			setHardness(-1.0F);
			setUnlocalizedName("jolin_portal");
			setRegistryName("jolin_portal");
			setLightLevel(0F);
		}
		...
		public void randomDisplayTick(IBlockState state, World world, BlockPos pos, Random random) {
			for (int i = 0; i < 4; i++) {
				...
				world.spawnParticle(EnumParticleTypes.SNOWBALL, px, py, pz, vx, vy, vz);
			}
	...
	public static class ChunkProviderModded implements IChunkGenerator {
		private static final IBlockState STONE = BlockPermafrost.block.getDefaultState();
		private static final IBlockState STONE2 = Blocks.SNOW.getDefaultState();
		private static final IBlockState FLUID = BlockAntifreeze.block.getDefaultState();
	...
	public static class GenLayerBiomesCustom extends GenLayer {
		private Biome[] allowedBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("venamod:jolinplains")),};
