...
public class BiomeJolinPlains extends ElementsVenaMod.ModElement {
	@GameRegistry.ObjectHolder("venamod:jolinplains")
	public static final BiomeGenCustom biome = null;
	public BiomeJolinPlains(ElementsVenaMod instance) {
		super(instance, 64);
	}
	...
	static class BiomeGenCustom extends Biome {
		public BiomeGenCustom() {
			super(new Biome.BiomeProperties("Jolin Plains").setRainfall(1F).setBaseHeight(0.01F).setWaterColor(-16759158).setHeightVariation(0F)
					.setTemperature(-1F));
