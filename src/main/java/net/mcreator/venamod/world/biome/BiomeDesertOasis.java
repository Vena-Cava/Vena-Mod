...
public class BiomeDesertOasis extends ElementsVenaMod.ModElement {
	@GameRegistry.ObjectHolder("venamod:desertoasis")
	public static final BiomeGenCustom biome = null;
	public BiomeDesertOasis(ElementsVenaMod instance) {
		super(instance, 57);
	}
	...
	public void init(FMLInitializationEvent event) {
		BiomeDictionary.addTypes(biome, BiomeDictionary.Type.HOT, BiomeDictionary.Type.WET);
		BiomeManager.addSpawnBiome(biome);
		BiomeManager.addBiome(BiomeManager.BiomeType.DESERT, new BiomeManager.BiomeEntry(biome, 10));
	}
	static class BiomeGenCustom extends Biome {
		public BiomeGenCustom() {
			super(new Biome.BiomeProperties("Desert Oasis").setRainfall(0.5F).setBaseHeight(0.03F).setHeightVariation(0.05F).setTemperature(0.5F));
			setRegistryName("desertoasis");
