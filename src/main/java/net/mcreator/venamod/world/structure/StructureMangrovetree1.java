...
public class StructureMangrovetree1 extends ElementsVenaMod.ModElement {
	public StructureMangrovetree1(ElementsVenaMod instance) {
		super(instance, 63);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 1000000) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("venamod", "mangrove_tree_1"));
				if (template == null)
					return;
