...
public class MCreatorCoconutmilk extends Elementsvenamod.ModElement {
	@GameRegistry.ObjectHolder("venamod:coconutmilk")
	public static final Item block = null;

	public MCreatorCoconutmilk(Elementsvenamod instance) {
		super(instance, 34);
	}
	...
	public static class ItemFoodCustom extends ItemFood {
		...
		protected void onFoodEaten(ItemStack itemStack, World world, EntityPlayer entity) {
			...
			int z = (int) entity.posZ;
			{
				...
				MCreatorCoconutmilkEaten.executeProcedure($_dependencies);
			}
		}
	}
}
