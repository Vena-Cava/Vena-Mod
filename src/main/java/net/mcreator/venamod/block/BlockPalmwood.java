...
public class BlockPalmwood extends ElementsVenaMod.ModElement {
	@GameRegistry.ObjectHolder("venamod:palmwood")
	public static final Block block = null;
	public BlockPalmwood(ElementsVenaMod instance) {
		super(instance, 3);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("palmwood"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("venamod:palmwood", "inventory"));
	}
