...
public class BlockBaobableaves extends ElementsVenaMod.ModElement {
	@GameRegistry.ObjectHolder("venamod:baobableaves")
	public static final Block block = null;
	public BlockBaobableaves(ElementsVenaMod instance) {
		super(instance, 9);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("baobableaves"));
