...
public class BlockPermafrostDiamondOre extends ElementsVenaMod.ModElement {
	@GameRegistry.ObjectHolder("venamod:permafrostdiamondore")
	public static final Block block = null;
	public BlockPermafrostDiamondOre(ElementsVenaMod instance) {
		super(instance, 32);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("permafrostdiamondore"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("venamod:permafrostdiamondore", "inventory"));
	}
