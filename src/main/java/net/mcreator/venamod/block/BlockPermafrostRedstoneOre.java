...
public class BlockPermafrostRedstoneOre extends ElementsVenaMod.ModElement {
	@GameRegistry.ObjectHolder("venamod:permafrostredstoneore")
	public static final Block block = null;
	public BlockPermafrostRedstoneOre(ElementsVenaMod instance) {
		super(instance, 31);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("permafrostredstoneore"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("venamod:permafrostredstoneore", "inventory"));
	}
