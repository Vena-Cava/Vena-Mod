...
public class BlockBaobabwood extends ElementsVenaMod.ModElement {
	@GameRegistry.ObjectHolder("venamod:baobabwood")
	public static final Block block = null;
	public BlockBaobabwood(ElementsVenaMod instance) {
		super(instance, 1);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("baobabwood"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("venamod:baobabwood", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.WOOD);
			setUnlocalizedName("baobabwood");
