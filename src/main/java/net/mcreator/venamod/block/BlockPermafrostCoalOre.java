...
public class BlockPermafrostCoalOre extends ElementsVenaMod.ModElement {
	@GameRegistry.ObjectHolder("venamod:permafrostcoalore")
	public static final Block block = null;
	public BlockPermafrostCoalOre(ElementsVenaMod instance) {
		super(instance, 28);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("permafrostcoalore"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("venamod:permafrostcoalore", "inventory"));
	}
