...
public class BlockPermafrostIronOre extends ElementsVenaMod.ModElement {
	@GameRegistry.ObjectHolder("venamod:permafrostironore")
	public static final Block block = null;
	public BlockPermafrostIronOre(ElementsVenaMod instance) {
		super(instance, 29);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("permafrostironore"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("venamod:permafrostironore", "inventory"));
	}
