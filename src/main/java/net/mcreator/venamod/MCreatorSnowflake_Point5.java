...
public class MCreatorSnowflake_Point5 extends Elementsvenamod.ModElement {
	public MCreatorSnowflake_Point5(Elementsvenamod instance) {
		super(instance, 64);
	}
		...
		public void eventHandler(RenderGameOverlayEvent event) {
			if (!event.isCancelable() && event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
				...
				if (((((entity.dimension) == (MCreatorJolin.DIMID)) && (!((entity instanceof EntityPlayer)
						...
						: false))) && ((venamodVariables.MapVariables.get(world).Heat) >= 5))) {
					Minecraft.getMinecraft().renderEngine.bindTexture(new ResourceLocation("venamod:textures/snowflake.png"));
					Minecraft.getMinecraft().ingameGUI.drawTexturedModalRect(posX + 51, posY + 70, 0, 0, 256, 256);
				}
			}
		}
	}
