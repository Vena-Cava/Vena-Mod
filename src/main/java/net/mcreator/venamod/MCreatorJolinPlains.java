...
public class MCreatorJolinPlains extends Elementsvenamod.ModElement {
	@GameRegistry.ObjectHolder("venamod:jolinplains")
	public static final BiomeGenCustom biome = null;

	public MCreatorJolinPlains(Elementsvenamod instance) {
		super(instance, 53);
	}
	...
	static class BiomeGenCustom extends Biome {
		public BiomeGenCustom() {
			super(new Biome.BiomeProperties("Jolin Plains").setRainfall(1F).setBaseHeight(0.1F).setWaterColor(-9718785).setHeightVariation(0.2F)
					.setTemperature(-1F));
			setRegistryName("jolinplains");
